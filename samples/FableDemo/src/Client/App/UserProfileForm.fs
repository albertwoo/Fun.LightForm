...
let render  = 
    FunctionComponent.Of
        (fun (state, dispatch) ->
            let lf = Hooks.useLightForm(UserProfile.defaultValue, States.validators)
            ...
            let createFields fnField =
                ...
                let field key renderer arg =
                    ...
                    | ActiveTab.UserProfileHookDemo   -> lf.CreateField key (renderer arg)
            ...
            div </> [
                ...
                Children [
                    ...
                    | ActiveTab.UserProfileHookDemo -> errorSummary lf.From
                    
                    infoCard [
                        Classes [ Tw.``text-green-600``; Tw.``bg-green-100`` ]
                        Children [
